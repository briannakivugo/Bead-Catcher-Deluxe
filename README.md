...
An arcade-style physics and collision game built to analyze variable reward states, escalating velocity and responsive input boundaries. 
## 🚀 Development & Sponsorship
This project was engineered and finalized through dual selective summer development pathways:
* Northeastern University Summer Program: Financial Aid recipient focusing on object-oriented architecture, coordinate systems and physics loops.
* Girls Who Code (GWC) Pathway Program: Advanced pathway tracking creative coding, canvas rendering and custom animation lifecycles.
